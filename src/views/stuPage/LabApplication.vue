    ...
    <el-dialog title="提示" :visible.sync="dialogVisible" width="50%" :before-close="handleClose">
      ...
      <el-form ref="form" :rules="rules"  :model="form" label-width="130px">
        ...
        <el-form-item label="申请学期" prop="semesterId">
          <el-select v-model="form.semesterId" placeholder="请选择申请学期">
        ...
        <el-form-item label="申请周次" prop="weekNumber">
          <el-input placeholder="请输入申请周次" v-model="form.weekNumber"></el-input>
        </el-form-item>

        <el-form-item label="申请节次" prop="sessionNumber">
          <el-input placeholder="请输入姓名" v-model="form.sessionNumber"></el-input>
        </el-form-item>

        <el-form-item label="申请实验室编号" prop="labNumber">
          <el-input placeholder="请输入申请实验室编号" v-model="form.labNumber"></el-input>
        </el-form-item>

        <el-form-item label="申请原因" prop="applicationReason">
          <el-input placeholder="请输入申请原因" v-model="form.applicationReason"></el-input>
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        weekNumber: [
          { required: true, message: '请选择申请周次' }
        ],
        sessionNumber: [
          { required: true, message: '请选择申请节次' }
        ],
        labNumber: [
          { required: true, message: '请选择申请实验室编号' }
        ],
        applicationReason: [
